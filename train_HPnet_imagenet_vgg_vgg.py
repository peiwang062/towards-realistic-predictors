...
parser.add_argument('--gpu', default='0,2,6,7', help='index of gpus to use')
...
def main():
    ...
    model_hp = models.__dict__['hp_net_vgg16']()
...
def save_checkpoint(state, is_best, filename='./imagenet/checkpoint_vgg_vgg.pth.tar'):
    torch.save(state, filename)
    if is_best:
        shutil.copyfile(filename, './imagenet/model_best_vgg_vgg.pth.tar')
...
def save_predicted_hardness(train_loader, val_loader, model_hp):
    ...
    sio.savemat('./imagenet/hardness_scores_vgg_vgg_tr.mat', {'hardness_scores_tr': hardness_scores_tr})
    sio.savemat('./imagenet/hardness_scores_idx_vgg_vgg_tr.mat', {'hardness_scores_idx_tr': hardness_scores_idx_tr})
    ...
    sio.savemat('./imagenet/hardness_scores_vgg_vgg_val.mat', {'hardness_scores_val': hardness_scores_val})
    sio.savemat('./imagenet/hardness_scores_idx_vgg_vgg_val.mat', {'hardness_scores_idx_val': hardness_scores_idx_val})
