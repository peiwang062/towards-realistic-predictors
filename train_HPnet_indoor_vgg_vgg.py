...
parser.add_argument('--gpu', default='4,5', help='index of gpus to use')
...
def save_checkpoint(state, is_best, filename='./indoor/checkpoint_vgg_vgg2.pth.tar'):
    torch.save(state, filename)
    if is_best:
        shutil.copyfile(filename, './indoor/model_best_vgg_vgg2.pth.tar')
...
def save_predicted_hardness(train_loader, val_loader, model_hp):
    ...
    sio.savemat('./indoor/hardness_scores_vgg_vgg_tr2.mat', {'hardness_scores_tr': hardness_scores_tr})
    sio.savemat('./indoor/hardness_scores_idx_vgg_vgg_tr2.mat', {'hardness_scores_idx_tr': hardness_scores_idx_tr})
    ...
    sio.savemat('./indoor/hardness_scores_vgg_vgg_val2.mat', {'hardness_scores_val': hardness_scores_val})
    sio.savemat('./indoor/hardness_scores_idx_vgg_vgg_val2.mat', {'hardness_scores_idx_val': hardness_scores_idx_val})
