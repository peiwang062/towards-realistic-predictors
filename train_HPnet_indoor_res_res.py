...
parser.add_argument('--gpu', default='4,6,7,8', help='index of gpus to use')
...
parser.add_argument('--lr_step', default='120', help='decreasing strategy')
...
def save_checkpoint(state, is_best, filename='./indoor/checkpoint_res_res2.pth.tar'):
    torch.save(state, filename)
    if is_best:
        shutil.copyfile(filename, './indoor/model_best_res_res2.pth.tar')
...
def save_predicted_hardness(train_loader, val_loader, model_hp):
    ...
    sio.savemat('./indoor/hardness_scores_res_res_tr2.mat', {'hardness_scores_tr': hardness_scores_tr})
    sio.savemat('./indoor/hardness_scores_idx_res_res_tr2.mat', {'hardness_scores_idx_tr': hardness_scores_idx_tr})
    ...
    sio.savemat('./indoor/hardness_scores_res_res_val2.mat', {'hardness_scores_val': hardness_scores_val})
    sio.savemat('./indoor/hardness_scores_idx_res_res_val2.mat', {'hardness_scores_idx_val': hardness_scores_idx_val})
